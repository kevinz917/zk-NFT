...
contract RevealVerifier {
  ...
  function verifyingKey() internal pure returns (VerifyingKey memory vk) {
    ...
    vk.delta2 = Pairing.G2Point(
      [14038822579609838563039233561472813301643390717035136869581907711254495197110, 16915609282895782242406017815727054878121047175502389286137701802560182328678],
      [14206256175762381380813479592700761513123953778542241689068989340349264108036, 6627602472838570926699662490468038565712103048275876532976745362179795398482]
    );
