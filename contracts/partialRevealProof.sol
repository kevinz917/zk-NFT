...
contract PartialRevealVerifier {
  ...
  function verifyingKey() internal pure returns (VerifyingKey memory vk) {
    ...
    vk.delta2 = Pairing3.G2Point(
      [2342370103378007647495574013413641720216710783931821449623313597538867555972, 15022928589119283343761901289663283304474186425977135577859822321815063510106],
      [2497324413855934090739185843495219242060111973041752224502412010077623125585, 20317543483388970062833325584999977398818207419511865097045044325874181505176]
    );
    vk.IC = new Pairing3.G1Point[](2);

    vk.IC[0] = Pairing3.G1Point(18150789909611917284814443467607941758254776929330724154042241652532646532097, 2459612237746639445525528880001876611127570333777051775714286839444529811903);

    vk.IC[1] = Pairing3.G1Point(12480265224741782472177455670000882484406172786765946318696021650689685851625, 11625773802266262742865030206990725077653058019476937912262416319901706959877);
  }
